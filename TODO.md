...
- [ ] 更新 `vite.config.js` 添加 PWA 插件配置

#### 4.2 创建 PWA 资源
- [ ] 创建 `public/manifest.json` - PWA 清单文件
- [ ] 准备应用图标（192x192 和 512x512）
  - [ ] 创建 `public/icon-192.png`
  - [ ] 创建 `public/icon-512.png`
- [ ] 配置 Service Worker（自动生成）
